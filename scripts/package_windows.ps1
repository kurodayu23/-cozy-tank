...
& $Python -m PyInstaller --noconfirm --clean --windowed --name "CozyTank" --distpath $OutputDirectory --workpath $buildPath --specpath $buildPath --add-data "$projectRoot/frontend;frontend" "$projectRoot/tank_game.py"
